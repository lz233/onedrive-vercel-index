...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'lz233@LaramieDep.onmicrosoft.com',
  ...
  email: 'mailto:ohayou@lz233.ac.cn',
